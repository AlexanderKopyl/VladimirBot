...
Посмотри моё обучающее видео с советами, как получить кредит в сложных случаях. ";
$ipoteka_text5 = "90% банков не одобряют ипотеку БЕЗ взноса. 
...
И второй момент - часто в программах по двум документа есть требование внести деньги на счёт в банке.";
